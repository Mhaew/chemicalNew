...
class View extends \Gcms\View
{
    ...
    public static function details($index)
    {
        ...
        $content .= '<tr><th>CAS Number</th><td>'.$index->cheme_no.'</td></tr>';
        $content .= '<tr><th>UN Class</th><td>'.$index->un_class.'</td></tr>';
        $content .= '<tr><th>Grade</th><td>'.$index->grade.'</td></tr>';
        $content .= '<tr><th>วันที่รับเข้า Lab</th><td>'.$index->exp.'</td></tr>';
        $content .= '<tr><th>Color</th><td>'.$index->sds.'</td></tr>';
        $content .= '</td></tr>';
        ...
        $content .= '<tr><th>ผู้ขาย</th><td>'.$index->seller.'</td></tr>';
